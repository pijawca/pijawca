...
|---------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------|-----------|-----------------|
| **auto-participation-########** | [![badge](https://img.shields.io/github/last-commit/pijawca/auto-participation-lolzuguru)](https://github.com/pijawca/auto-participation-lolzuguru) | **TRUE**  | **NEED UPDATE** |
